...
Mention that browse mode opens a temporary bottom turn list pane showing `Turn x/y` and prompt first lines. The highlighted list item follows the main pane as the user jumps between turns.
